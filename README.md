...
I've led cross-functional teams, shipped production platforms serving global customers, and driven quantum-safe security initiatives resulting in an IEEE publication. I enjoy solving complex systems problems end-to-end — from low-level protocol work to LLM-powered agent architectures.
...
`Next.js` `FastAPI` `LangGraph` `Supabase (PgVector)` `Stripe`

### Post-Quantum Cryptography for Enterprise Identity
Hybrid quantum-safe key exchange (X25519Kyber768) integrated into a production identity server.  
`Java` `TLS 1.3` `Kyber-AES` `BouncyCastle`

### Multi-Tenant Task Management Platform
Distributed task orchestration with tenant isolation, circuit breakers, and event-driven architecture.  
...
<p align="center">
  ...
  <a href="https://linkedin.com/in/ashendesilva"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" /></a>
  <a href="mailto:ashendesilva.eng@gmail.com"><img src="https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white" /></a>
</p>
